#-------------------------------------------------------------------------------------
# HSAF - Model Data Dynamic SoilMoisture H14 Raw Stats
...
#
# Example: 
# python Model_DynamicData_HSAF_SoilMoisture_H14_Raw_Stats.py -settingfile settingfile.config -logfile logfile.config
#
# General example usage: 
# python Model_DynamicData_HSAF_SoilMoisture_H14_Raw_Stats.py
# -settingfile /home/fabio/Documents/Working_Area/Code_Development/Workspace/Liclipse_Workspace/Project_HSAF/Product_SoilMoisture_2016/config_algorithm/model_dynamicdata_hsaf-sm-h14-raw-stats_algorithm_local_history.config
# -logfile /home/fabio/Documents/Working_Area/Code_Development/Workspace/Liclipse_Workspace/Project_HSAF/Product_SoilMoisture_2016/config_logs/model_dynamicdata_hsaf-sm-h14-raw-stats_logging_local_history.config
#
# Versions:
...
def GetArgs():
    ...
    if oParserValue.sSettingFile:
        ...
        sSettingsFile = 'model_dynamicdata_hsaf-sm-h14-raw-stats_algorithm.config'
    
    if oParserValue.sLoggingFile:
        sLoggingFile = oParserValue.sLoggingFile
    else:
        sLoggingFile = 'model_dynamicdata_hsaf-sm-h14-raw-stats_logging.config'
...
if __name__ == "__main__":
    ...
    sAlgName = 'HSAF SOILMOISTURE H14 RAW STATS'
    #-------------------------------------------------------------------------------------
    ...
    try:
        ...
        from Cpl_Apps_Model_DynamicData_HSAF_SoilMoisture_H14_Raw_Stats import Cpl_Apps_Model_DynamicData_HSAF_SoilMoisture_H14_Raw_Stats
    ...
    try:
        ...
        #-------------------------------------------------------------------------------------
        # Dynamic Data
        oCpl_DynamicData = Cpl_Apps_Model_DynamicData_HSAF_SoilMoisture_H14_Raw_Stats(oDataTime=oDataTime, oDataGeo=oDataGeo, oDataInfo=oDataInfo)
