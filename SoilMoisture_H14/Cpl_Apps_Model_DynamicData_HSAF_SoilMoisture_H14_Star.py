...
Name:          Cpl_Apps_Model_DynamicData_HSAF_SoilMoisture_H14_Star
...
from src.Lib_Op_Dict_Apps import prepareDictKey, lookupDictKey, removeDictKey, getDictKeyRecursive
...
# -------------------------------------------------------------------------------------
# Class
class Cpl_Apps_Model_DynamicData_HSAF_SoilMoisture_H14_Star:
    ...
    def checkDynamicData(self, sTime):
        ...
        for sFileType in oVarsWorkspace_CHK:
            ...
            if sFileType == 'NetCDF':
                ...
                # Check file
                sFileCache_CHK = os.path.join(sPathCache_CHK, 'Model_HSAF-SM-H14-STAR_FILENC_' + sTime_CHK + '.history')
    ...
    def parserDynamicData(self, sTime):
        ...
        if a1oFileDataDyn_GET and a1oFileStatsDyn_GET:
            ...
            #oData_PAR_1 = open('oData_PAR_SM.pkl', 'wb')
            #pickle.dump(a1oFileDataDyn_PAR, oData_PAR_1)
            #oData_PAR_1.close()
            #oData_PAR_2 = open('oStats_PAR_SM.pkl', 'wb')
            #pickle.dump(self.a1oFileStatsDyn_PAR, oData_PAR_2)
            #oData_PAR_2.close()
            #oData_PAR_3 = open('oVars_PAR_SM.pkl', 'wb')
    ...
    def computeDynamicData(self, sTime):
        ...
        #import pickle
        #os.chdir(self.sPathClass)
        #oData_PAR_1 = open('oData_PAR_SM.pkl', 'rb')
        #a1oFileDataDyn_PAR = pickle.load(oData_PAR_1)
        #oData_PAR_1.close()
        #oData_PAR_2 = open('oStats_PAR_SM.pkl', 'rb')
        #a1oFileStatsDyn_PAR = pickle.load(oData_PAR_2)
        #oData_PAR_2.close()
        #oData_PAR_3 = open('oVars_PAR_SM.pkl', 'rb')
        ...
        if a1oFileDataDyn_PAR and a1oFileStatsDyn_PAR:
            ...
            for iFileDataDyn_PAR, sFileDataDyn_PAR in enumerate(a1oFileDataDyn_PAR):
                ...
                for sVarInfoDyn_PAR, sVarInfoDyn_CMP in a1oVarsInfoDyn_PAR.iteritems():
                    ...
                    oVarStats_PAR = {'Var_1': None, 'Var_2': None}
                    ...
                    oVarDrv = Drv_Analysis_Cmp(Lib_Analysis_Cmp, sVarMethodCmp_PAR,
                                               ...
                                               a2dVarMin=oVarStats_PAR['Var_1'],
                                               a2dVarMax=oVarStats_PAR['Var_2'])
                    ...
                    # Debug
                    #plt.figure(1)
                    #plt.imshow(a2dVar_CMP); plt.colorbar(); plt.clim(0, 1);
                    #plt.show()
                    # -------------------------------------------------------------------------------------
                ...
                if sFileType == 'NetCDF':
                    ...
                    for sVarKeys_OUT, sVarName_OUT in a1oVarsInfoDyn_PAR.iteritems():
                        ...
                        if sVarName_OUT in oVarsInfo_OUT:
                            ...
                            # -------------------------------------------------------------------------------------
                            # Filename NC OUT
                            sFileNameDyn_OUT = defineFileName(join(sPathDataDyn_OUT,
                                                              oVarsInfo_OUT[sVarName_OUT]['VarSource']), self.oTags)
                            ...
                            try:
                                ...
                                if not bFileExistDyn_OUT:
                                    ...
                                    oFileDrv_OUT.oFileData = oFileDrv_OUT.oFileLibrary.writeDims(oFileData_OUT, sDimVarX,
                                                                                                 self.oDataGeo.iCols)
                                    sDimVarY = oVarsInfo_OUT['Terrain']['VarDims']['Y']
                                    oFileDrv_OUT.oFileData = oFileDrv_OUT.oFileLibrary.writeDims(oFileData_OUT, sDimVarY,
                                                                                                 self.oDataGeo.iRows)
                                    sDimVarT = 'time'
                                    oFileDrv_OUT.oFileData = oFileDrv_OUT.oFileLibrary.writeDims(oFileData_OUT, sDimVarT,
                                                                                                 iVarLen_OUT)
                    ...
                    if np.all(np.asarray(a1bFileCheck_HIS) == True):
                        ...
                        sFileCache_HIS = os.path.join(sPathCache_HIS,
                                                      'Model_HSAF-SM-H14-STAR_FILENC_' + sTime_SAVE + '.history')
