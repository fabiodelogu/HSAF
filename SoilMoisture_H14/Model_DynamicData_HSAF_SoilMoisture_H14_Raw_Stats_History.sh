...
# Run algorithm 
python Model_DynamicData_HSAF_SoilMoisture_H14_Raw_Stats.py -settingfile /home/gabellani/HSAF_Data_Processing/Product_SoilMoisture/H14/config_algorithm/model_dynamicdata_hsaf-sm-h14-raw-stats_algorithm_server_history.config -logfile /home/gabellani/HSAF_Data_Processing/Product_SoilMoisture/H14/config_logs/model_dynamicdata_hsaf-sm-h14-raw-stats_logging_server_history.config
