#-------------------------------------------------------------------------------------
# HSAF - Model Data Dynamic SoilMoisture H14 Raw
...
#
# Example: 
# python Model_DynamicData_HSAF_SoilMoisture_H14_Raw.py -settingfile settingfile.config -logfile logfile.config
#
# General example usage: 
# python Model_DynamicData_HSAF_SoilMoisture_H14_Raw.py
# -settingfile /home/fabio/Documents/Working_Area/Code_Development/Workspace/Liclipse_Workspace/Project_HSAF/Product_SoilMoisture_2016/config_algorithm/model_dynamicdata_hsaf-sm-h14-raw_algorithm_server_history.config
# -logfile /home/fabio/Documents/Working_Area/Code_Development/Workspace/Liclipse_Workspace/Project_HSAF/Product_SoilMoisture_2016/config_logs/model_dynamicdata_hsaf-sm-h14-raw_logging_server_history.config
#
# Versions:
...
def GetArgs():
    ...
    if oParserValue.sSettingFile:
        ...
        sSettingsFile = 'model_dynamicdata_hsaf-sm-h14-raw_algorithm.config'
    
    if oParserValue.sLoggingFile:
        sLoggingFile = oParserValue.sLoggingFile
    else:
        sLoggingFile = 'model_dynamicdata_hsaf-sm-h14-raw_logging.config'
...
if __name__ == "__main__":
    ...
    sProjectName = 'Model'
    sAlgName = 'HSAF SOILMOISTURE H14 RAW'
    #-------------------------------------------------------------------------------------
    ...
    try:
        ...
        from Cpl_Apps_Model_DynamicData_HSAF_SoilMoisture_H14_Raw import Cpl_Apps_Model_DynamicData_HSAF_SoilMoisture_H14_Raw
    ...
    try:
        ...
        #-------------------------------------------------------------------------------------
        # Dynamic Data
        oCpl_DynamicData = Cpl_Apps_Model_DynamicData_HSAF_SoilMoisture_H14_Raw(oDataTime=oDataTime, oDataGeo=oDataTerrain, oDataInfo=oDataInfo)
