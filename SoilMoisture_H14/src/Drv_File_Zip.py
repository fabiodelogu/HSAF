...
import Lib_File_Zip_Apps as Lib_File_Zip_Apps
        ...
        if not sZipType == 'NoZip':
            if not self.sFileName_OUT:
                if self.sZipMode is 'z':
                    ...
                    [sFileName_OUT, sZipType] = Lib_File_Zip_Apps.addFileExtZip(self.sFileName_IN, sZipType)
                elif self.sZipMode is 'u':
                    self.sZipType = Lib_File_Zip_Apps.getFileExtZip(self.sFileName_IN)[0]
                    sFilePath_OUT = self.sFilePath_IN
                    [sFileName_OUT, sZipType] = Lib_File_Zip_Apps.removeFileExtZip(self.sFileName_IN, self.sZipType)
...
class BZ2:
    ...
    def setFileLibZip(self):
        ...
        import Lib_File_Zip_BZ2 as oFileLibrary
...
class GZip:
    ...
    def setFileLibZip(self):
        ...
        import Lib_File_Zip_GZip as oFileLibrary
        self.oFileLibrary = oFileLibrary
