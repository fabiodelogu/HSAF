...
def TimeFiles(sFileName, sTimeFormat):
    ...
    if (str(a1iTime[0]) == '03'):
        ...
        sTimeFile = sTimeFile.replace('HHMMSS', str(a1iTime[2])+'00')
...
def SearchFiles(sPathDataSource, sDataName, sFormatTime, sDataTime, sFileExt=None):
    ...
    if sDataName.lower() == 'h03':
        ...
        sDateStrSearch =  sFormatTime + 'rom.grb.' + str(sFileExt)
        
        print('STRING SEARCH: ' + sDateStrSearch)
...
class ComputeProductData:
    ...
    #-------------------------------------------------------------------------------------
    # Method time info
    def __init__(self, sTimeNow, oTime, oGeoRef, oSatRef, oSettings):
    ...
    def CreateProduct(self):
        ...
        self.a1sProductFile = SearchFiles(sPathDataDynamicSource, sProductNameIN, sProductTimeFormatIN, sTimeNow, 'gz')
        ...
        if self.a1sProductFile:
            ...
            for sProductFile in self.a1sProductFile:
                ...
                # Update product time (considering format yyyymmddHHMM)
                    ...
                    if oDataRaw.oDataProduct != None:
                        ...
                        if a1oDataElab is not None and np.any(np.isfinite(a1oDataElab.values())):
                            ...
                            for sVarData in a1oDataElab:
                                ...
                                a1iGeoDataNan = np.where(np.isnan(a1dDataElab))
