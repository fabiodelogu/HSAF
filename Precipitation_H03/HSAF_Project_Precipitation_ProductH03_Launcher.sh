...
cd /home/gabellani/HSAF_Data_Processing/Product_Precipitation/H03/

# Italy
python HSAF_Project_Precipitation_ProductH03_Ver3.py settings_precipitation_product_h03_italy.txt 

# Serbia
#python HSAF_Project_Precipitation_ProductH03_Ver3.py settings_precipitation_product_h03_serbia.txt &

# Lebanon
#python HSAF_Project_Precipitation_ProductH03_Ver3.py settings_precipitation_product_h03_lebanon.txt
