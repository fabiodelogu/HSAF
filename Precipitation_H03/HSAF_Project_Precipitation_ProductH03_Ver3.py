#----------------------------------------------------------------------------
"""
Project HSAF - PRECIPITATION PRODUCT H03
...
python HSAF_Project_Precipitation_ProductH03_VerX.py settings_precipitation_product_h03.txt
...
#----------------------------------------------------------------------------
# Start Program
print('[' + sProjectName + '] - PRECIPITATION PRODUCT H03 (Version ' + sProgramVersion + ')]')
...
try:
    ...
    if sSettingsFile != None:
        ...
        sSettingsFile = 'settings_precipitation_product_h03.txt'
