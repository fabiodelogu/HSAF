#-------------------------------------------------------------------------------------
# HSAF - Data Dynamic SoilWaterIndex H16 Star
...
#
# Example: 
# python Satellite_DynamicData_HSAF_SWI_H16_Star.py -settingfile settingfile.config -logfile logfile.config
#
# General example usage: 
# python Satellite_DynamicData_HSAF_SWI_H16_Star.py
# -settingfile /home/fabio/Documents/Working_Area/Code_Development/Workspace/Liclipse_Workspace/Project_HSAF/Product_SoilMoisture_2016/config_algorithm/satellite_dynamicdata_hsaf-swi-h16-star_algorithm_server_history.config
# -logfile /home/fabio/Documents/Working_Area/Code_Development/Workspace/Liclipse_Workspace/Project_HSAF/Product_SoilMoisture_2016/config_logs/satellite_dynamicdata_hsaf-swi-h16-star_logging_server_history.config
#
# Versions:
# 20161024 (4.0.1) --> Fix bug(s) and update code(s)
...
def GetArgs():
    ...
    if oParserValue.sSettingFile:
        ...
        sSettingsFile = 'satellite_dynamicdata_hsaf-swi-h16-star_algorithm.config'
    
    if oParserValue.sLoggingFile:
        sLoggingFile = oParserValue.sLoggingFile
    else:
        sLoggingFile = 'satellite_dynamicdata_hsaf-swi-h16-star_logging.config'
...
if __name__ == "__main__":
    ...
    try:
        ...
        from Cpl_Apps_Satellite_DynamicData_HSAF_SWI_H16_Star import Cpl_Apps_Satellite_DynamicData_HSAF_SWI_H16_Star
    ...
    try:
        ...
        #-------------------------------------------------------------------------------------
        # Get terrain data
        oDataTerrain = DataGeo(
            join(oDataInfo.oInfoSettings.oPathInfo['DataStatic'],
                 oDataInfo.oInfoVarStatic.oDataInputStatic['ASCII']['Terrain']['VarSource'])).getDataGeo()

        # Get statistics data - H07
        oDataStats = DataAncillary(
            sFileName=join(oDataInfo.oInfoSettings.oPathInfo['DataAncillary'],
                           oDataInfo.oInfoVarStatic.oDataInputStatic['NetCDF']['SWI_Statistics']['VarSource']),
            sDataName='SWI_Statistics',
        ...
        oDataStats = DataAncillary(
            ...
            sTimeNow=oDataInfo.oInfoSettings.oParamsInfo['TimeNow'],
            oDataObject=oDataStats).getData()
        ...
        #-------------------------------------------------------------------------------------
        # End section
        oLogStream.info('[' + sProjectName + '] DataDynamic - Initialize ' + sAlgName + ' ... OK')
        #-------------------------------------------------------------------------------------
    ...
    try:
        ...
        #-------------------------------------------------------------------------------------
        # Dynamic Data
        oCpl_DynamicData = Cpl_Apps_Satellite_DynamicData_HSAF_SWI_H16_Star(oDataTime=oDataTime, oDataGeo=oDataTerrain,
