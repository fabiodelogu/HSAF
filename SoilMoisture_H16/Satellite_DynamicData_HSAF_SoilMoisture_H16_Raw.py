#-------------------------------------------------------------------------------------
# HSAF - Data Dynamic SoilMoisture H16 Raw
...
#
# Example: 
# python Satellite_DynamicData_HSAF_SoilMoisture_H16_Raw.py -settingfile settingfile.config -logfile logfile.config
#
# General example usage: 
# python Satellite_DynamicData_HSAF_SoilMoisture_H16_Raw.py
# -settingfile /home/fabio/Documents/Working_Area/Code_Development/Workspace/Liclipse_Workspace/Project_HSAF/Product_SoilMoisture_2016/config_algorithm/satellite_dynamicdata_hsaf-sm-h16-raw_algorithm_server_history.config
# -logfile /home/fabio/Documents/Working_Area/Code_Development/Workspace/Liclipse_Workspace/Project_HSAF/Product_SoilMoisture_2016/config_logs/satellite_dynamicdata_hsaf-sm-h16-raw_logging_server_history.config
#
# Versions:
...
def GetArgs():
    ...
    if oParserValue.sSettingFile:
        ...
        sSettingsFile = 'satellite_dynamicdata_hsaf-sm-h16-raw_algorithm.config'
    
    if oParserValue.sLoggingFile:
        sLoggingFile = oParserValue.sLoggingFile
    else:
        sLoggingFile = 'satellite_dynamicdata_hsaf-sm-h16-raw_logging.config'
...
if __name__ == "__main__":
    ...
    sAlgName = 'HSAF SOILMOISTURE H16 RAW'
    #-------------------------------------------------------------------------------------
    ...
    try:
        ...
        from Cpl_Apps_Satellite_DynamicData_HSAF_SoilMoisture_H16_Raw import Cpl_Apps_Satellite_DynamicData_HSAF_SoilMoisture_H16_Raw
    ...
    oLogStream.info('[' + sProjectName + '] DataDynamic - Initialize HSAF SOILMOISTURE H16 ... ')
    ...
    try:
        ...
        #-------------------------------------------------------------------------------------
        # Dynamic Data
        oCpl_DynamicData = Cpl_Apps_Satellite_DynamicData_HSAF_SoilMoisture_H16_Raw(oDataTime=oDataTime, oDataGeo=oDataTerrain, oDataInfo=oDataInfo)
