...
# Run algorithm 
python Satellite_DynamicData_HSAF_SWI_H16_Raw.py -settingfile /home/gabellani/HSAF_Data_Processing/Product_SoilMoisture/H16/config_algorithm/satellite_dynamicdata_hsaf-swi-h16-raw_algorithm_server_history.config -logfile /home/gabellani/HSAF_Data_Processing/Product_SoilMoisture/H16/config_logs/satellite_dynamicdata_hsaf-swi-h16-raw_logging_server_history.config
