...
from Lib_Data_Geo_Apps import defineGeoGrid, defineGeoCorner, defineGeoHeader, readGeoBox, readGeoHeader, checkGeoDomain
...
class DataGeo:
    ...
    def getDataGeo(self):
        ...
        if bFileName and isfile(self.__sFileName):
            ...
            Exc.getExc(' -----> ERROR: both filename and geographical box are undefined! (' + self.__sFileName + ')', 1, 1)
