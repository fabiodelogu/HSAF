#-------------------------------------------------------------------------------------
# Satellite - Data Dynamic Soil Water Index H16 Raw Stats
...
#
# Example: 
# python Satellite_DynamicData_HSAF_SWI_H16_Raw_Stats.py -settingfile settingfile.config -logfile logfile.config
#
# General example usage: 
# python Satellite_DynamicData_HSAF_SWI_H16_Raw_Stats.py
# -settingfile /home/fabio/Documents/Working_Area/Code_Development/Workspace/Liclipse_Workspace/Project_HSAF/Product_SoilMoisture_2016/config_algorithm/satellite_dynamicdata_hsaf-swi-h16-raw-stats_algorithm_server_history.config
# -logfile /home/fabio/Documents/Working_Area/Code_Development/Workspace/Liclipse_Workspace/Project_HSAF/Product_SoilMoisture_2016/config_logs/satellite_dynamicdata_hsaf-swi-h16-raw-stats_logging_server_history.config
#
# Versions:
# 20161021 (4.0.1) --> First release 4.0.0
# 20160704 (4.0.0) --> First release 4.0.0
...
def GetArgs():
    ...
    if oParserValue.sSettingFile:
        ...
        sSettingsFile = 'satellite_dynamicdata_hsaf-swi-h16-raw-stats_algorithm.config'
    
    if oParserValue.sLoggingFile:
        sLoggingFile = oParserValue.sLoggingFile
    else:
        sLoggingFile = 'satellite_dynamicdata_hsaf-swi-h16-raw-stats_logging.config'
...
if __name__ == "__main__":
    ...
    sAlgName = 'HSAF SWI H16 RAW STATS'
    #-------------------------------------------------------------------------------------
    ...
    try:
        ...
        from Cpl_Apps_Satellite_DynamicData_HSAF_SWI_H16_Raw_Stats import Cpl_Apps_Satellite_DynamicData_HSAF_SWI_H16_Raw_Stats
    ...
    try:
        ...
        #-------------------------------------------------------------------------------------
        # Get terrain data and put into geographical data
        oDataGeo = DataGeo(join(oDataInfo.oInfoSettings.oPathInfo['DataStatic'],
    ...
    try:
        ...
        #-------------------------------------------------------------------------------------
        # Dynamic Data
        oCpl_DynamicData = Cpl_Apps_Satellite_DynamicData_HSAF_SWI_H16_Raw_Stats(oDataTime=oDataTime, oDataGeo=oDataGeo, oDataInfo=oDataInfo)
