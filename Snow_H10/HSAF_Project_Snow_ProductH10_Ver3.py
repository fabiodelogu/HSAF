...
python HSAF_Project_Snow_ProductH10_VerX.py settings_snow_product_h10.txt

Version:
20141204 (3.0.0) --> New release starting from Ver. 2
...
#----------------------------------------------------------------------------
# Versioning
sProgramVersion = '3.0.0'
sProjectName = 'PROJECT HSAF'
#----------------------------------------------------------------------------

#----------------------------------------------------------------------------
# Start Program
print('[' + sProjectName + '] - SNOW PRODUCT H10 (Version ' + sProgramVersion + ')]')
...
try:
    ...
    if sSettingsFile != None:
        ...
        sSettingsFile = 'settings_snow_product_h10.txt'
...
try:
    ...
    for sTimeNow in oDataTime.a1sTimeRun:
        ...
        oDriverCreate = ComputeProductData.ComputeProductData(sTimeNow, oDataTime, oDataGeoRef, oDataSettings)
