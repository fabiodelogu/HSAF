...
K_NCOLS = "ncols"
K_NROWS = "nrows"
K_XLLCORNER = "xllcorner"
K_YLLCORNER = "yllcorner"
K_CELLSIZE = "cellsize"
K_NODATAVALUE = "NODATA_value"
K_NCELLS = "Ncells"
K_CELL = "cell"
K_LAT = "lat"
K_LNG = "lng"
...
def read_ARCINFO_ASCII_grid(filename, FLAG="UNFILTERED", INTflag=0):
	...
	"NODATA_value" : atof(split(f.readline())[1]),
	}
#    print fileTable
...
if __name__=="__main__":
  a, values = read_ARCINFO_ASCII_grid("mississipi.dem.txt")
  pass
